...
<ul>
    <li>
        <stripes:link beanclass="${actionBean.getClass()}" event="simpleredirectresolution">
            Simple RedirectResolution
        </stripes:link>
    </li>
    <li>
        <stripes:link beanclass="${actionBean.getClass()}" event="complexredirectresolution">
    ...
    <li>
        <stripes:link beanclass="${actionBean.getClass()}" event="simplestreamingresolution">
    ...
    <li>
        <stripes:link beanclass="${actionBean.getClass()}" event="streamfilestreamingresolution">
